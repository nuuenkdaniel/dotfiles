...
Window {
  id: root
  title: "caelestia-player" // Set to target with Hyprland window rules
  
  // Replaced implicit sizes with explicit window sizes[cite: 1]
  width: 520
  height: 180
  
  color: "transparent"
  flags: Qt.FramelessWindowHint // Removes native OS titlebars
  visible: false // Start hidden for the keybind toggle

  // The IPC Handler to listen for your keybind
  IpcHandler {
    target: "media_player"
    function toggle() {
